...
import SecretsProviderConnectionModal from './SecretsProviderConnectionModal.vue';
...
vi.mock('../composables/useSecretsProviderConnection', () => ({
	useSecretsProviderConnection: vi.fn(() => mockConnection),
}));

vi.mock('../composables/useConnectionModal', () => ({
