...
export default defineConfig(
	...
	},
	{
		...
		files: [
			...
			'./src/public-api/v1/handlers/users/users.handler.ts',
	...
	},
	{
		...
		files: [
			...
			'./src/credentials/credentials.feature.service.ts',
			...
			'./src/workflows/workflow.feature.service.ts',
			...
			'./src/evaluation/evaluation-collection.service.ts',
			'./src/evaluation/test-runner/test-runner.service.ts',
			'./src/public-api/v1/handlers/tags/tags.handler.ts',
			...
			'./src/modules/dynamic-credentials/services/credential-resolver.service.ts',
			'./src/modules/external-secrets/secrets-providers-connections.service.ts',
			...
			'./src/modules/log-streaming/log-streaming-destination.service.ts',
			...
			'./src/modules/provisioning/role-mapping-rule.service.ts',
			'./src/modules/provisioning/role-resolver.service.ts',
			'./src/modules/source-control/source-control-context.factory.ts',
			'./src/modules/source-control/source-control-export.service.ts',
			'./src/modules/source-control/source-control-import.service.ts',
			'./src/modules/source-control/source-control-scoped.service.ts',
			'./src/modules/source-control/source-control-status.service.ts',
	...
	},
	{
		...
		files: [
			...
			'./src/modules/dynamic-credentials/services/credential-resolver-workflow.service.ts',
