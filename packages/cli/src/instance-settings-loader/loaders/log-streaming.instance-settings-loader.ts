...
import { EventDestinations } from '@/modules/log-streaming/database/entities';
import { EventDestinationsRepository } from '@/modules/log-streaming/database/repositories/event-destination.repository';
