...
import type { SourceControlImportService } from '../source-control-import.service';
...
import { sourceControlFoldersExistCheck } from '../source-control-helper';
...
vi.mock('../source-control-helper', async () => ({
	...(await vi.importActual<typeof import('../source-control-helper')>('../source-control-helper')),
...
describe('SourceControlService', () => {
	...
	describe('disconnect', () => {
		...
		// Note: Broadcast tests have been moved to source-control-preferences.service.test.ts
