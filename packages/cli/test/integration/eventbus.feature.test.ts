...
import type { MessageEventBusDestinationSentry } from '@/modules/log-streaming/destinations/message-event-bus-destination-sentry';
import type { MessageEventBusDestinationSyslog } from '@/modules/log-streaming/destinations/message-event-bus-destination-syslog';
import type { MessageEventBusDestinationWebhook } from '@/modules/log-streaming/destinations/message-event-bus-destination-webhook';
